...
const HeroContent = () => {
	...
	return (
		<Row>
			<Col lg={{ span: 8, offset: 2 }} md={12} sm={12} className="mb-6">
				{/* caption */}
				<h1 className="display-2 fw-bold mb-3">
					Hi there, we’re <span className="text-primary">Cybrom</span>
				</h1>
				{/* para  */}
				<p className="h2 mb-3 ">
				...
				<p className="mb-0 h4 text-body lh-lg">
					Cybrom provide clean and consistent page designs to help you to create
					beautiful looking contents. Cybrom is feature-rich components and
