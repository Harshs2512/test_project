...
const CodeCard = ({ item, free, viewby, showprogressbar, extraclass }) => {
  const GridView = () => {
    return (
      <Card
      ...
      >
        ...
        <Card.Body>
          ...
          <ListGroup as="ul" bsPrefix="list-inline" className="mb-3">
            <ListGroup.Item
              ...
              dangerouslySetInnerHTML={{
                __html: item?.contest_description
                  .split(" ")
                  .slice(0, 20)
                  .join(" "),
              }}
          ...
          <span><del> ₹ {item.actualprice}</del></span>
          </div>
        </Card.Body>
        {/* Card Footer */}
        <Card.Footer>
          <Row className="align-items-center g-0">
            <Col className="col-auto">
              <GKTippy content="Learning Level">
                <Badge className="bg-success ">{item.contest_level}</Badge>
              </GKTippy>
            </Col>
          </Row>
          ...
          <div className="text-center">
            <Link
              href={`/studio/code/Code-single/codesingle?id=${item._id}`}
