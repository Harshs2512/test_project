...
export const EarningsChartOptions = {
	...
	xaxis: {
		...
		axisTicks: { show: !1 },
		crosshairs: { show: !0 },
		labels: { style: { fontSize: "13px", fontWeight: 400, colors: theme.gray500, fontFamily: "inter" } },
	},
	yaxis: {
		labels: {
...
export const BudgetExpenseChartOptions = {
	...
	xaxis: {
		...
		labels: {
			show: !0,
			style: { colors: [theme.gray400, theme.gray400, theme.gray400, theme.gray400, theme.gray400, theme.gray400], fontSize: "14px", fontFamily: "Inter", fontWeight: 600 },
		},
	},
	responsive: [
		{
...
export const TaskSummaryChartOptions = {
	...
	yaxis: { labels: { style: { fontSize: "13px", fontWeight: 400, colors: theme.gray500, fontFamily: "inter" } } },
	grid: { borderColor: theme.borderColor },
};
