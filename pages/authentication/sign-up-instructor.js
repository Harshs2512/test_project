...
const SignUp = (req, res) => {
	...
	const submitHandler = async ({ fname, lname, email, password }) => {
		setLoading(true)
		try {
			const result = await axios.post("/api/auth/signupinstructor", {
				redirect: false,
				fname,
				lname,
				email,
	...
	return (
		<Fragment>
			...
			<Modal show={showModal} onHide={() => setShowModal(false)}>
				...
				<Modal.Body>
					Your registration is currently being reviewed. You will receive an email once your account is approved.
				</Modal.Body>
				<Modal.Footer>
