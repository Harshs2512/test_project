...
const AddRole = () => {
    ...
    const submitData = async () => {
        try {
            const res = await axios.post(`/api/rolesandpermission/addrole`, formData);
            if (res.status === 201) {
