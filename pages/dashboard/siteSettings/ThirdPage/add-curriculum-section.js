...
const AddCurriculum = () => {
    ...
    const submitData = async (e) => {
        e.preventDefault();
        try {
            const res = await axios.post(`/api/siteSettings/thirdPage/curriculumSection/addRecord`, formData);
            if (res.status === 201) {
                ...
                <Col lg={12} md={12} sm={12}>
                    <div className="border-bottom pb-4 mb-4 d-md-flex align-items-center justify-content-between">
                        <div className="mb-3 mb-md-0">
                            <h1 className="mb-1 h2 fw-bold">Add Curriculum</h1>
                            <Breadcrumb>
                                <Breadcrumb.Item href="#">Dashboard</Breadcrumb.Item>
                                <Breadcrumb.Item href="#">Third</Breadcrumb.Item>
                                <Breadcrumb.Item active>Add Curriculum</Breadcrumb.Item>
                            </Breadcrumb>
                        </div>
                    </div>
                </Col>
                ...
                <Col lg={12} md={12} sm={12}>
                    <Card>
                        <Card.Header className="d-flex justify-content-between align-items-center border-bottom card-header-height mb-4" >
                            <h4 className="mb-0">Add Curriculum</h4>
                        </Card.Header>
