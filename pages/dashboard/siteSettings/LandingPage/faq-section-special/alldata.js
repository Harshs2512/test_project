                ...
                <Col lg={12} md={12} sm={12}>
                    <div className="border-bottom pb-4 mb-4 d-md-flex align-items-center justify-content-between">
                        <div className="mb-3 mb-md-0">
                            <h1 className="mb-1 h2 fw-bold">Faq For Special Course</h1>
                            <Breadcrumb>
                                <Breadcrumb.Item href="#">Dashboard</Breadcrumb.Item>
                                <Breadcrumb.Item href="#">FAQ</Breadcrumb.Item>
                                <Breadcrumb.Item active>Faq For Special Course</Breadcrumb.Item>
                            </Breadcrumb>
                        </div>
                        <div>
                            <Can I="createBlogCategory">
                                <Link href="/dashboard/siteSettings/LandingPage/faq-section-special/add-data" className="btn btn-outline-primary">
                                    Add new
                                </Link>
                            </Can>
                        </div>
