...
import { AddNewShortCourse } from 'sub-components';
const AddNewShortCourses = () => {
						...
						<Col lg={{ span: 10, offset: 1 }} md={12} sm={12}>
							<div className="d-lg-flex align-items-center justify-content-between">
								<div className="mb-4 mb-lg-0">
									<h1 className="text-white mb-1">Add New Short Course</h1>
									<p className="mb-0 text-white lead">
										Just fill the form and create your Short Course of the Day.
									</p>
								</div>
								<div>
									<Link
...
export default AddNewShortCourses;
