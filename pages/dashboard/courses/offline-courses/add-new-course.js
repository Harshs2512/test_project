...
import { BasicInformationOffline, CoursesMedia, Curriculum, Settings } from 'sub-components';
...
const AddNewCourse = () => {
	...
	const steps = [
		{
			id: 1,
			title: 'Section 1 (Second Page)',
			content: (
				<BasicInformationOffline
					next={next}
	...
	return (
		<Fragment>
			...
			<section className="py-4 py-lg-6 bg-primary rounded">
				<Container>
					<Row>
						<Col lg={{ span: 10, offset: 1 }} md={12} sm={12}>
							<div className="d-lg-flex align-items-center justify-content-between rounded">
								...
								<div>
									<Link
										href="/dashboard/courses/offline-courses/all-courses"
