...
const QuestinUpdate = () => {
    ...
    const fetchQuiz = useCallback(async () => {
        try {
            ...
            setsetsingleQuiz(response && response.data.quiz);
        } catch (error) {
            ...
            <div>
                <Form>
                                    ...
                                    {options.map((option, index) => (
                                        <div key={index}>
                                            <Row className="mt-5">
                                                ...
                                                <Col className=" mt-5 d-flex">
                                                    <input type="checkbox" className="react-toggle react-toggle-track-check mx-4"
                                                        checked={option.correctAnswer}
                    ...
                    <Form.Group>
                        <Row>
                            <Col className="mt-4">
                                <Button type="button" onClick={handleAddOption} className="p-1">
                                    Add Option
                                </Button>
                            </Col>
                        </Row>
                    ...
                    <Form.Group>
                        ...
                        <Row>
                            ...
                            <Col>
                                <Button variant="primary" className="p-1" onClick={() => handleEditQuestion(quizId, questionId)} >
                                    Update Question
                                </Button>
                            </Col>
                        </Row>
