...
const AddInstructor = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const res = await axios.get(`/api/auth/instructorsingle/${id}`)
                if (res.status === 200) {
                    const user = res.data;
                    setFormData({
                        fname: user.fname,
    ...
    const submitData = async () => {
        try {
            const res = await axios.put(`/api/auth//instructorsingle/${id}`, formData);
            if (res.status === 201) {
                ...
                <Col lg={12} md={12} sm={12}>
                    <div className="border-bottom pb-4 mb-4 d-md-flex align-items-center justify-content-between">
                        <div className="mb-3 mb-md-0">
                            <h1 className="mb-1 h2 fw-bold">Edit Instructor</h1>
                            <Breadcrumb>
                ...
                <Col lg={12} md={12} sm={12}>
                    <Card>
                        <Card.Header className="d-flex justify-content-between align-items-center border-bottom card-header-height mb-4">
                            <h4 className="mb-0">Edit Instructor</h4>
