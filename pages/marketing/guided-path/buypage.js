...
const BuyPage = () => {
  ...
  const data = async () => {
    const res = await axios.get(`/api/Course-guide/${Id}`);
            ...
            <Col xl={8} lg={8} md={12} sm={12}>
              ...
              <Card className="mb-4">
                ...
                <Card.Header className="d-flex align-items-center justify-content-between card-header-height">
                  <h4 className="mb-0">Guided Course</h4>
                    ...
                    <ListGroup.Item className={`px-0`}>
                      <Row>
                        <Col className="col-auto">
                          <Link href="#">
                            <Image
                              src={`/api/Course-guide/getthumbnail/${BuyCourse?._id}`}
                        ...
                        <Col className="ps-0">
                          ...
                          <h5 className="mb-2">
                            Guide Level : <Badge className="bg-success">
                                {BuyCourse?.contest_level}
                            </Badge>
                    ...
                    <ListGroup.Item as="li" className="mb-2" bsPrefix=" ">
                      <div className="d-flex align-items-center justify-content-between ">
                        <div className="mb-1 mb-lg-0 ">
                          <span>{BuyCourse && BuyCourse.contest_title}</span>
                        </div>
                        <div>
