...
import { FormSelect, PageHeadingBriefinfo, GeeksSEO } from 'widgets';

// import sub components
import { CoursePathCard }  from 'sub-components';
...
const CoursePath = () => {
	...
	return (
		<Fragment>
			{/* Geeks SEO settings  */}
			<GeeksSEO title="Course Paths | Cybrom Technology Pvt.Ltd."/>
