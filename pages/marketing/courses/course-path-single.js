...
import { GeeksSEO, GKTippy } from 'widgets';

// import sub components
import { CoursesTab, AboutTab, AuthorTab } from 'sub-components';
...
const CoursePathSingle = () => {
	...
	return (
		<Fragment>
			{/* Geeks SEO settings  */}
			<GeeksSEO title="Course Path Single | Cybrom Technology Pvt.Ltd." />
								...
								<div className="d-md-flex align-items-center justify-content-between bg-white  pt-3 pb-3 pb-lg-5">
									...
									<div className="mt-3 mt-lg-0 text-lg-start text-center d-flex">
										<GKTippy content="Add to Bookmarks" >
											<Link href="#"><i className="text-muted btn-icon btn-light rounded-circle fe fe-bookmark fs-4"></i></Link>
										</GKTippy>
										<ActionMenu />
									</div>
								</div>
