												...
												<div className="mt-5">
													...
													<div className="d-flex align-items-center justify-content-between mb-4">
														...
														<div className="d-flex justify-content-between mx-6 ">
															<ActionMenu />
															<Link href="/marketing/courses/buy_courses" className='ms-2 p-1 btn btn-primary'>Dashboard</Link>
														</div>
													</div>
													<div className="mb-10">
							...
							<section className="card course-sidebar " id="courseAccordion">
								<SimpleBar style={{ maxHeight: '93vh' }}>
									<Card>
										...
										<GKAccordionDefault accordionItems={course} onDataChange={handleVideourlChange} isAdmin={false}/>
									</Card>
								</SimpleBar>
							</section>
						</main>
