...
import QuizInformation from 'sub-components/instructor/add-new-course/steps/add-new-quiz/QuizInformation';
...
const AddNewQuiz = () => {
	...
	return (
		<Fragment>
			{/* Geeks SEO settings  */}
			<GeeksSEO title="Add Mock Test | cybrom technology pvt.ltd." />
						...
						<Col lg={{ span: 10, offset: 1 }} md={12} sm={12}>
							<div className="d-lg-flex align-items-center justify-content-between">
								<div className="mb-4 mb-lg-0">
									<h1 className="text-white mb-1">Add New Mock Test</h1>
								...
								<div>
									<Link
										href="/marketing/instructor/quiz"
										className="btn btn-white ">
										Back to Mock Question
									</Link>{' '}
									<Link
