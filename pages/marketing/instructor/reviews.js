...
import { FormSelect, InstructorReviewCard, GeeksSEO } from 'widgets';

// import profile layout wrapper
import ProfileLayout from 'layouts/marketing/instructor/ProfileLayout';

// Import required data files
import { InstructorReviewsData } from 'data/instructor/InstructorReviewsData';
...
const Reviews = () => {
	...
	return (
		<ProfileLayout>
			{/* Geeks SEO settings  */}
			<GeeksSEO title="Reviews | Cybrom Technology Pvt. Ltd." />
