...
const Subscriptions = () => {
	...
	return (
		<ProfileLayout>
			{/* Geeks SEO settings  */}
			<GeeksSEO title="Subscriptions | Cybrom Technology Pvt. Ltd." />
			...
			<Card className="border-0">
				<Card.Header className="d-lg-flex justify-content-between align-items-center">
					...
					<div>
						<Link href="/marketing/pages/pricing/" className="btn btn-success btn-sm">
					...
					<div className="pt-5">
						<Row className="mb-4">
							...
							<Col className="col-auto">
								<Link href="#" className="btn btn-light btn-sm disabled">
									Disabled
								</Link>
							</Col>
						</Row>
